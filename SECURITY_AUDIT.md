...
- INFO-03 — No X-Frame-Options / clickjacking protection ⚠️ Needs HTTP header (hosting layer)
...
| INFO-03 | No clickjacking protection | `index.html` | Info | **Open** | Meta tag removed (browsers ignore it); needs `X-Frame-Options: DENY` as HTTP response header at hosting layer |
